...
class KagiSearchProvider {
  ...
  async apiKey(options, signal) {
    ...
    throw new WebError(
      `Kagi search has no API key for "${options.apiKeyEnv ?? DEFAULT_API_KEY_ENV}"; store it through the credentials service, export it in the launching environment, or set a literal "apiKey" in the web-search-kagi config`,
...
/** Clamp a result limit to Kagi's 1–1024 contract. */
